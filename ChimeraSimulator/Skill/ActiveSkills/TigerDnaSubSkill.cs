...
public class TigerDnaSubSkill : DnaSubSkill, IDefendSkill
{
    public TigerDnaSubSkill(GeneType geneType) : base(geneType)
    {
        GeneType = geneType;
    }
    
    public override string SkillName { get;} = "역습 준비";
    ...
    private float maxAmount { get; } = 100;
