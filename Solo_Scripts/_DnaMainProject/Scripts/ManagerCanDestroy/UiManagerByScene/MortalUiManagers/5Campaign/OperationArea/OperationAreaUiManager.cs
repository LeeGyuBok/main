...
public class OperationAreaUiManager : MortalManager<OperationAreaUiManager>
{
    ...
    [SerializeField] private Button enterCampaignButton;
    ...
    public GameObject selectedMapObject { get; private set; }
    ...
    {
        GameImmortalManager.Instance.SetSelectedOperators(new List<FriendlyOperator>(selectedFriendlyOperators));
        GameImmortalManager.Instance.SetCampaignMapObject(selectedMapObject);
