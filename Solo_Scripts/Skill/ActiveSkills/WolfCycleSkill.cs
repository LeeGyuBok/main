...
public class WolfCycleSkill : CycleSkill
{
    ...
    public override string SkillName { get; protected set; } = "OffenceStance of Pack";
    public override string SkillDescription { get; protected set; } = "OffenceStance of Pack";
}
