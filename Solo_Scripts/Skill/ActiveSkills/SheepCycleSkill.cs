...
public class SheepCycleSkill : CycleSkill
{
    ...
    public override string SkillName { get; protected set; } = "DefenseStance of Pack";
    public override string SkillDescription { get; protected set; } = "DefenseStance of Pack";
}
